    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('visa-types.update',$visa_type->id) }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="visa_type" type="text" class="form-control @error('visa_type') is-invalid @enderror" name="visa_type" value="{{ old('visa_type',$visa_type->visa_type) }}" required autocomplete="visa_type" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">                             
                                ...
                                <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code',$visa_type->code) }}" required autocomplete="code" autofocus>
