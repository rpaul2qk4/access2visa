...
@section('content')			  
<div class="bg-white mt-4 p-md-5 rounded shadow-sm align-middle1" style="margin-left:20px !important;margin-right:20px !important;">
		...
		<div class="col-12">
		  ...
		  <div class="d-flex gap-2 gap-md-2 flex-column flex-md-row justify-content-md-between">
				...
				@if (Route::has('password.request'))
					<a class="link-secondary text-warning text-decoration-none" href="{{ route('password.request') }}">
